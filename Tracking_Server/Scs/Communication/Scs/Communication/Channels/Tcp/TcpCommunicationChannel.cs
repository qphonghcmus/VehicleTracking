...
namespace Hik.Communication.Scs.Communication.Channels.Tcp
{
    ...
    internal class TcpCommunicationChannel : CommunicationChannelBase
    {
        ...
        private readonly Timer _timerConnect = new Timer(10000);
        ...
        /// <summary>
        /// Disconnect client from server when a period time ends 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void _timerConnect_Elapsed(object sender, EventArgs e)
        {
            Disconnect();
        }
